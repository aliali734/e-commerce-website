/**
 * Handles the reset-password form submission on the client side.
...
async function handleResetPasswordSubmit() {
  ...
  try {
    const response = await fetch(`${window.BACKEND_URL}/auth/user/reset-password`, {
      method: "POST",
      credentials: "include",
      headers: {
...
document.getElementById("resetBtn").addEventListener("click", handleResetPasswordSubmit);
